...
import { AcademicCapIcon, BuildingOfficeIcon, LightBulbIcon, WrenchIcon } from "@heroicons/react/24/outline";
...
import { addSectionInForm, deleteSectionInFormByIdx, moveSectionInForm } from "@/app/lib/redux/resumeSlice";
    ...
    <>
      ...
      <div className="relative grid grid-cols-6 gap-3">
        ...
        <div className={`absolute right-0 top-0 flex gap-0.5`}>
          ...
          <div className={`transition-all duration-300 ${showMoveUp ? "" : "invisible opacity-0"}`}>
          ...
          <div className={`transition-all duration-300 ${showDelete ? "" : "invisible opacity-0"}`}>
            <DeletIconButton onClick={handleDeleteClick} tooltipText={deleteButtonTooltipText} />
          </div>
        </div>
      </div>
    </>
