...
const JOB_TITLES = ["Analyst", "Agent", "Administrator", "Architect", "Assistant", "Associate", "CTO"];
...
export const extractWorkExperience = (sections: ResumeSectionToLines) => {
  ...
  for (const subsectionLines of subsections) {
    ...
    const subsectionDescriptionLines = subsectionLines.slice(descriptionsLineIdx);
